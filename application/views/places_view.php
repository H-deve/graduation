 ...
 <section class="content">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div>
              <a href="<?php echo base_url();?>place"  class="btn btn-success">>ADD NEW Place</a> 
</div>
                ...
                <tr>
                  ...
                  <td><?php echo $id->latidue ; ?></td>
                   <td><?php echo $id->longitude ; ?></td>
                    ...
                    <td>  
                    <a href="<?php echo base_url();?>Map_co/update_Dplace?id=<?php echo  $id->id?>"  class="btn btn-primary">UPDATE</a> 

                  <a href="<?php echo base_url();?>Map_co/delete?id=<?php echo  $id->id?>" class="btn btn-danger">DELETE
                  </a></td>
