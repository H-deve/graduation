...
<div class="row">
  ...
  <div class="box box-primary">
            ...
            <form role="form" action="<?php base_url();?>place/save" method="POST">
              <div class="box-body">
                <div class="form-group">
                 <label for="ex3">place name</label>
                   <input class="form-control" name="place_name" id="ex1" type="text" placeholder="Enter place_name">
                </div>
                <div class="form-group">
            ...
            <input class="form-control" name="description" id="ex2" type="text"  placeholder="Enter your description">
                 ...
                 <div class="form-group">
                <label for="ex3">latitude</label>latitude
                 <input type="text"disabled="" class="form-control" name="latitude" id="lat" >
                 </div>

         <div class="form-group">
            <label for="ex3">longitude</label>
            <input type="text" disabled="" class="form-control" name="longitude" id="lang" >
          </div>
              ...
              <div class="col-md-6">
                 ...
                 <div class="dropdown">
                 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" >CHOOSE PLACE PLEASE
           ...
           <input type="hidden" name="type" id="type" value="Restaurant">
              ...
              <div class="row">
              <div class="col-md-12">
            <form role="role" action="<?php  echo base_url()?>place/save" method="post">
              <div>
          ...
          <div class="row">
              <div class="col-md-12">
          <!-- <form role="role" action="<?php echo base_url()?>Map_co/show_new_places" method="get">
          <div>

                 <button type="submit" class="btn btn-show">SHOW PLACES</button>
                 </div>
            </form> -->
            </div>
            </div>
