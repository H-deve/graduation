...
<div class="row">
            ...
            <div class="col-md-6">
              <form role="form" action="<?php echo base_url();?>Map_co/save_update">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
          <label for="ex3">place_name</label>
            <input value="<?php echo $da->description?>" class="form-control" name="place_name" id="ex2" type="text"  placeholder="Enter place_name">
                </div>


                 <div class="form-group">
                <label for="ex3">latitude</label>
      <input value="<?php echo $da->latidue?>" type="text"  class="form-control" name="latidue" id="lat" >
                 </div>

                  <div class="form-group">
                  <label for="ex3">longitude</label>
 <input value="<?php echo $da->longitude?>" type="text"  class="form-control" name="longitude" id="lang" >
          </div>

          <div class="form-group">
          <label for="ex3">description</label>
            <input value="<?php echo $da->description?>" class="form-control" name="description" id="ex2" type="text"  placeholder="Enter your description">
                </div>
          ...
          <button type="submit" class="btn btn-success">UPDATE</button>
              ...
              <form role="form" action="<?php base_url();?>Map_co" method="post">
                <div>
